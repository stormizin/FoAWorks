        ...
        <div class="right">
          ...
          <nav>
            <ul id="menu">
              ...
              <li id="menu_active"><a href="loginemp.php">Empresarial</a></li>
...
<div class="main">
  <section id="content">
    ...
    <article class="col2 pad_left1">
        <center>
            <form name="dados" method="POST" id="ContactForm" action="auth.php" OnSubmit="return enviardados();">
                    <h2>Apenas administradores podem logar nesta sessao.</h2>
          <div class="wrapper">
            <div class="bg">
          ...
          <div class="wrapper">
            ...
            <script language="Javascript">
                function enviardados(){
                    ...
                    {
                        alert("Campo de login esta vazio.");
