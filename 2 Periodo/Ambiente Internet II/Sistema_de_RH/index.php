...
<div id="templatemo_menu_wrapper">
    <div id="templatemo_menu">
        ...
        <ul>
            ...
            <li><a href="candidato.php">Cadastrar</a></li>
        </ul>    	
...
<div id="templatemo_content_wrapper">
    ...
    <div id="templatemo_content">
        ...
        <center>
        	<h2>Faça seu Select Login!</h2>
                <form name="dados" action="auth.php" method="POST">
                <table>
                    <tr>
                        <td>CPF:</td><td><input type="text" name="usuario"></td>
                    <tr>
            ...
            <a href="candidato.php">&bullet; Ainda não tem um login? Faça seu cadastro e rápido e simples!</a>
        </div>
