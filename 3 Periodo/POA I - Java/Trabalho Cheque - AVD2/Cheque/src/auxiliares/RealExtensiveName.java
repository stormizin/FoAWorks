...
public class RealExtensiveName {
         ...
         *  Construtor
         */
        public RealExtensiveName() {
                nro = new ArrayList<Integer>();
        }


        /**
         *@param   valor para colocar por extenso
         */
        public RealExtensiveName(BigDecimal dec) {
                this();
                setNumber(dec);
        }
        ...
        /**
         *  Constructor for the RealExtensiveName object
         *
         *@param  dec  value to put in extensive name
         */
        public RealExtensiveName(double dec) {
                this();
                setNumber(dec);
        }
        ...
        /**
         *  Sets the Number attribute of the ValorExtenso object
         *
        ...
        /**
         *  Adds a feature to the Remainder attribute of the ValorExtenso object
         *
